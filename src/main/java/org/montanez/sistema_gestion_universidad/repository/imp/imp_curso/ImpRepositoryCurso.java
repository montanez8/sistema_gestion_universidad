package org.montanez.sistema_gestion_universidad.repository.imp.imp_curso;
...
public class ImpRepositoryCurso implements RepositoryCurso {
    ...
    public static void main(String[] args) {
        try {
            ImpRepositoryCurso impRepositoryCurso = new ImpRepositoryCurso();
            impRepositoryCurso.listar().forEach(System.out::println);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
